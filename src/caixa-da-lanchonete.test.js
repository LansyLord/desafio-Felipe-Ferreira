...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['dinheiro', 'R$ 4,28', ['cafe,1', 'chantily,1']],
        ['credito', 'R$ 4,63', ['cafe,1', 'chantily,1']],
        ['debito', 'R$ 4,50', ['cafe,1', 'chantily,1']],
    ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);

    test.each([
        ['dinheiro', 'R$ 4,28', ['chantily,1', 'cafe,1']],
        ['credito', 'R$ 4,63', ['chantily,1', 'cafe,1']],
        ['debito', 'R$ 4,50', ['chantily,1', 'cafe,1']],
    ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);
